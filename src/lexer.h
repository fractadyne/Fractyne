...
typedef enum {
    ...
    TOK_LET, TOK_FN, TOK_IF, TOK_ELSE, TOK_WHILE, TOK_FOR, TOK_RETURN, TOK_OUTPUT,
    TOK_PUSH, TOK_LEN, TOK_BREAK, TOK_CONTINUE, TOK_STRUCT, TOK_INVOLVE,
    TOK_SORT, TOK_REVERSE, TOK_CONTAINS, TOK_REMOVE,
    TOK_TRUE, TOK_FALSE,
