...
typedef enum {
    ...
    TOK_LET, TOK_FIXED, TOK_FR, TOK_IF, TOK_ELSE, TOK_WHILE, TOK_FOR, TOK_RETURN, TOK_OUTPUT,
    ...
    TOK_BRANCH, TOK_CASE, TOK_COMPOSE,
    TOK_TRUE, TOK_FALSE,
    ...
    TOK_AMP_ASSIGN, TOK_PIPE_ASSIGN, TOK_CARET_ASSIGN, TOK_SHL_ASSIGN, TOK_SHR_ASSIGN,
